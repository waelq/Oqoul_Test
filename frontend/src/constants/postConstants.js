...
export const POST_LISTUSER_REQUEST = "POST_LISTUSER_REQUEST";
export const POST_LISTUSER_SUCCESS = "POST_LISTUSER_SUCCESS";
export const POST_LISTUSER_FAIL = "POST_LISTUSER_FAIL";
export const POST_LISTUSER_RESET = "POST_LISTUSER_RESET";
